...
public class Hero extends Char {
	...
	/** ~~~~~~~~~ KarH Notes ~~~~~~~~~
	 * Hero的构造函数与HeroClass的initHero方法都仅在生成新存档的时候出现一次
	 * 那为什么要在这里初始化英雄...
	 * 作为规范，今后除了法力值之外的初始化都塞到initHero里面
	 *  ~~~~~~~~~ KarH Notes ~~~~~~~~~*/
	public Hero() {
		super();
	...
	// 更新最大生命值，如果勾选boostHP则同步加血，例如升级，例如根骨秘药
	// 不更新的例如升级根骨之戒
	...
	// ......... Begin ......... Edited by KarH
	// 不要忘记保存与恢复
	private static final String MANA_CUR    = "mana_cur";
	...
	public void storeInBundle( Bundle bundle ) {
		...
		// ......... Begin ......... Edited by KarH
		bundle.put( MANA_CUR, mana_cur );
		bundle.put( MANA_MAX, mana_max );
		// `````````` End ``````````
	}
	...
	public void restoreFromBundle( Bundle bundle ) {
		...
		// ......... Begin ......... Edited by KarH
		mana_cur = bundle.getInt( MANA_CUR );
		mana_max = bundle.getInt( MANA_MAX );
		// `````````` End ``````````
	}
